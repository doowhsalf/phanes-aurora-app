...
cd source
ssh -fN -L 48484:localhost:48484 -p 2251 johang@217.70.37.84
sh ../build_core.sh
...
# meteor yarn add echarts-for-react
# meteor yarn add date-fns
export MONGO_URL='mongodb://127.0.0.1:48484/edge_gudrun_search'
meteor --port 3080 --settings settings_osx.json
echo "Launched..."
