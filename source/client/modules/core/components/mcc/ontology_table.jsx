...
const rows = [
  ...
  {
    id: "updatedAsDateString",
    numeric: false,
    disablePadding: false,
    label: "UpdatedAsDateString",
  },
];
  ...
  renderLabel(labelid) {
    ...
    switch (labelid) {
      ...
      case "_id":
        ...
        break;
      case "name":
        label = i18n.__("Table_Column_Ontotology_Name");
        break;
      case "description":
        label = i18n.__("Table_Column_Ontotology_Description");
        break;
      case "foldername":
        label = i18n.__("Table_Column_Ontotology_Foldername");
        break;
      case "ontology":
        label = i18n.__("Table_Column_Ontotology_Ontology");
        break;
      case "superclass":
        label = i18n.__("Table_Column_Ontotology_Superclass");
        break;
      case "type":
        label = i18n.__("Table_Column_Ontotology_Type");
        break;
      case "updated":
        label = i18n.__("Table_Column_Ontotology_Updated");
        break;
      case "updatedAsDateString":
        label = i18n.__("Table_Column_Ontotology_UpdatedAsDateString");
        break;
      default:
        break;
    }
              ...
              {stableSort(nodeConfigs, getSorting(order, orderBy))
                ...
                .map((n) => {
                  return (
                    ...
                    >
                      <TableCell align="left">{getField(n, "_id")}</TableCell>
                      <TableCell align="left">
                        {getField(n.name, "en")}
                      </TableCell>
                      <TableCell align="left">
                        {getField(n.description, "en")}
                      </TableCell>
                      <TableCell align="left">
                        {getField(n, "foldername")}
                      </TableCell>
                      <TableCell align="left">
                        {getField(n, "ontology")}
                      </TableCell>
                      <TableCell align="left">
                        {/* {getField(n, "superclass")} */}
                        {this._renderSuperClass(n)}
                         
                      </TableCell>
                      <TableCell align="left">{getField(n, "type")}</TableCell>

                      <TableCell align="left">
                        {getField(n, "updated")}
                      </TableCell>
                      <TableCell align="left">
                        {getField(n, "updatedAsDateString")}
                      </TableCell>
                    </TableRow>
                  );
                })}
