...
import MccConfigTableData from "../../containers/mcc_config_table_data";
...
class MccConfigTable extends React.Component {
  constructor(props) {
...
MccConfigTable.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(MccConfigTable);
