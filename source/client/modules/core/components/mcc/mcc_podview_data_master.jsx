...
import EventFlow from "../../containers/nodes_getall_events";
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <Typography variant="h4">Data - latest received</Typography>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={12}>
            <Paper className={classes.card}>
              <EventFlow searchText={this.state.filter}></EventFlow>
            </Paper>
          </Grid>
        </Grid>
      </div>
