...
class FieldPersonNameAvatar extends React.Component {
  constructor(props) {
  ...
  render() {
    const { classes, uri, label, disabled } = this.props;
...
FieldPersonNameAvatar.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(FieldPersonNameAvatar);
