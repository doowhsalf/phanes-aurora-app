...
class FieldGoToPerson extends React.Component {
  constructor(props) {
  ...
  render() {
    const { variant, classes, personid, label } = this.props;
...
FieldGoToPerson.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(FieldGoToPerson);
